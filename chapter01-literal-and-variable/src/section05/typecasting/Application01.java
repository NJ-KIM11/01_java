...
public class Application01 {
    public static void main(String[] args) {
        ...
        * */
        ...
        // 작은 자료형에서 큰 자료형으로 자동 형변환 한다.
        // 데이터 손실이 발생하지 않기 때문에 컴팡일러가 자동으로 처리해준다.
        ...
        //int result1 = num1 +num2; //long 을 int 에 담으려고 했기에 불가능
