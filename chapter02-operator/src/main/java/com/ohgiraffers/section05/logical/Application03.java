...
public class Application03 {
    public static void main(String[] args) {
        ...
        * */
        ...
        /*
        * &&
        * 조건식 두 개가 모두 만족해야 true 를 반환하지만 앞에서 미리 false 가 나오게 되면
        * 뒤의 조건을 확인할 필요 없이 false를 반환한다.
        * 따라서 연산 횟수를 줄이기 위해서는 && 연산의 경우 false 가 나올 확률이 높은 조건을 앞에 작성 하는 것이 좋다.
        * */
        ...
        /*
        * ||
        * 조건식 둘 중 하나라도 true 를 반환하면 true 를 반환하기 때문에
        * 앞에서 미리 true 가 나오게 되면 뒤의 조건을 확인할 필요 없이 true를 반환한다.
        * */
