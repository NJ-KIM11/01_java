...
public class Application03 {
    public static void main(String[] args){
        ...
        /*
        * 전달인자(argument = arg), 매겨변수(parameter) 를 이용한 메소드 호출
        *
        * 변수의 종류
        ...
        * 메소드 호출시 사용하는 괄호를 이용해서 값을 전달할 수 있다.
        ...
        * */
        ...
        app3.testMethod(20);
        //app3.testMethod(1,2,3); //갯수가 일치하지 않으면 호출할 수 없다.
        //app3.testMethod("30"); //자료형이 일치하지 않으면 호출할 수 없다.
        //app3.testMethod(); //매개변수가 있지만 인자로 값을 전달하지 못하면 호출할 수 없다.

        //변수에 저장한 값 전달
        int age = 20;
        app3.testMethod(age); //age라는 변수가 아니라 20 이라는 값이 전달

        //자동 형변환을 이용한 값 전달
        byte byteAge = 20;
        app3.testMethod(byteAge); //byte에서 int 로 자동 형변환 후 전달
