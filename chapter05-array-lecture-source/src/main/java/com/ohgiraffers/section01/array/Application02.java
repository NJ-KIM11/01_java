...
public class Application02 {
    public static void main(String[] args) {
        ...
        * 반환하는 연산자이다. 발생한 주소를 (레퍼런스 주소)에 저장하여
        ...
        * */
        ...
        System.out.println("darr = " + darr.hashCode());
        System.out.println("darr = " + darr.length);
        //hashcode가 달라졌다는건 기존 배열의 크기만 달라진게 아니라 heap 영역에 새로운 공간을 할당하고 새로운 주소값을 받는다.
        //바뀌기전 heap 영역에 저장되 있던 공간은 garbage collector가 특정 시점에 가져가서 없어진다.
