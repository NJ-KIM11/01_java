package main.java.com.ohgiraffers.section02.dimensional;
...
public class Application01 {
    public static void main(String[] args) {
        ...
        * 더 많은 차원의 배열을 사용할 수 있지만, 일반적으로 2차원 배열보다 높은 차원의 배열은 사용 빈도가 현저하게 떨어진다.
        * */
        ...
        * */
        ...
        //배열의 주소를 관리하는 배열의 길이는 정수형으로 반드시 크기를 지정해 주어야 한다.
        iarr1 = new int[3][];
        /*iarr2 = new int[][];
        iarr2 = new int[][3];*/             //불가
