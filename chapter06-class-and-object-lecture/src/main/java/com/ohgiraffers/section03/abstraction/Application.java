...
public class Application {
    public static void main(String[] args) {
        ...
        /*
        *객체 지향 프로그래밍이란?
        * 현실세계에 모든 사건(event) 는 객체와 객체의 상호작용에 의해
        ...
        * 책임을 가지고 있어야 한다.(단일 책임의 원칙)
        * */

        /*
        * 객체를 설계하기 위해서는 복잡한 현실세계를 그대로 반영하기에는
        * 너무 방대하고 복잡하기 때문에 현실세계를 프로그램의 목적에 맞게
        ...
        * 즉, 재사용성이 높아질수 있게 한다는 의미이다.
        * 객체의 재사용성이 증가한면 중복 작성되는 코드를 줄일 수 있으며,
        ...
        * 메세지를 보내는 쪽(메소드 호출) 을 송신자 라고 하고,
        * 메세지르 수신하는 쪽은 수신자 라고 한다.
        ...
        * 5. 카레이서가 엑셀을 밟을면 시동이 걸린 상태일 경우 10km/h 씩 증가하며 앞으로 나간다.
...
//return은 메소드를 종료시킨다. main 메소드의 경우 return 이 나오면 main 메소드가 종료된다.
