...
public class Application {
    public static void main(String[] args) {
        ...
        OldCar avante = new OldCar("H", 1700, "avante", "gasoline");
        ...
        Car[] cars = {porter, kona, ionic2, sonata, avante};        //어떤 자식이든 부모에 넣어 줄수 있다.
        seller.sale(cars);
        /////////하나의 메소드로 여러 클래스를 한번에 대응할 수 있다.
        /////////어떤 클래스가 대응 될지는 실행시에 결정된다.(동적 바인딩)
